...
const (
	NUM_HBM_INSTANCE   = C.AMDSMI_NUM_HBM_INSTANCES
	MAX_NUM_VCN        = C.AMDSMI_MAX_NUM_VCN
	MAX_NUM_CLKS       = C.AMDSMI_MAX_NUM_CLKS
	MAX_NUM_XGMI_LINKS = C.AMDSMI_MAX_NUM_XGMI_LINKS
	MAX_NUM_GFX_CLKS   = C.AMDSMI_MAX_NUM_GFX_CLKS
	MAX_AID            = C.AMDSMI_MAX_AID
	MAX_ENGINES        = C.AMDSMI_MAX_ENGINES
	MAX_NUM_JPEG       = C.AMDSMI_MAX_NUM_JPEG
)
